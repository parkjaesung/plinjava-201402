...
public class RandomLadderCreator {
	...
	static Position convertTotalPositionsToPosition(
			NaturalNumber totalPositions, NaturalNumber height,
	...
	static NaturalNumber getPositionOfHeight(
			NaturalNumber totalPositions, NaturalNumber noOfPerson) {
		double ceilDividende = Math.ceil(totalPositions.getNumber() / (double)noOfPerson.getNumber());
